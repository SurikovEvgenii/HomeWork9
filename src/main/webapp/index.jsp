...
<body style="padding: 100px">
    ...
    <% if(session.getAttribute("authResult")=="true"){ %>
        ...
        <p><b>Количество вопросительных предложений:</b> ${requestScope.get("counter")}</p><br>
        <p>${questions}</p>
        <p>Для демонстрации наличия Cookie:</p>
        <p>${cookie}</p>
        <p>Время захода: ${sessionScope.get("time")}</p>
        <p>Дата захода: ${sessionScope.get("date")} </p>
